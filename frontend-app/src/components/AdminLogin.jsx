...
const AdminLogin = () => {
  ...
  const handleAdminLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://veg-order-platform.vercel.app/auth/login', {
        email,
        password,
      });
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      <form onSubmit={handleAdminLogin} className="bg-white p-6 rounded shadow-md w-80">
        <input
          type="email"
